...
public class Main {
    ...
    public static File file = new File("C:\\Users\\ahmedelsayed\\Desktop\\output.txt");
    public static File file1 = new File("C:\\Users\\ahmedelsayed\\Desktop\\out.txt");

    public static void main(String[] args) throws IOException {

        /*readImage("C:\\Users\\ahmedelsayed\\Desktop\\lena.jpg");
...
//        System.out.println("_________________________-------" + pixels.length);
        getCodes();
//        System.out.println("/////////////-----" + data.size());
        ...
        //System.out.println("_______________________________hhhhhhhhh                   " + vv.length);
